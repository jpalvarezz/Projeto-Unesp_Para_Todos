...
export default function ExercisePage({ titulo, questoes }: Props) {
                  ...
                  <div className="pt-6 border-t border-gray-100 flex flex-col items-center">
                    ...
                    <div className="flex justify-center gap-3 md:gap-4">
                      {q.alternativas.map((letra) => {
                        ...
                        let btnClasses =
                          "border-2 bg-white text-gray-600 border-gray-200 hover:border-purple-500 hover:bg-purple-50";
